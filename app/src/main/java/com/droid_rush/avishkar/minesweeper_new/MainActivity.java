package com.droid_rush.avishkar.minesweeper_new;
...
public class MainActivity extends AppCompatActivity {
    ...
    Block blocks[][];
    int blockDimension = 100; // width of each block
    int blockPadding = 2; // padding between blocks
    int numberOfRowsInMineField = 9;
    int numberOfColumnsInMineField = 9;
    int totalNumberOfMines = 10;
    Handler timer = new Handler();//for timer
    int secondsPassed = 0;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Typeface lcdFont = Typeface.createFromAsset(getAssets(),"fonts/digital-7 (mono italic).ttf");//changing font of timer and mines left
        ...
        showDialog("Tap the smiley for a new game", 2000, true, false);
    }
    ...
    private void showMineField()
    {
        for (int row = 1; row < numberOfRowsInMineField + 1; row++)
        {
            ...
            tableRow.setLayoutParams(new LayoutParams((blockDimension + blockPadding) * numberOfColumnsInMineField, blockDimension + blockPadding));
            ...
            for (int column = 0; column < numberOfColumnsInMineField + 2; column++)
            {
                ...
                blocks[row][column].setOnClickListener(new OnClickListener()
                {
                    ...
                    public void onClick(View view)
                    {
                        ...
                        txtMineCount.setText(minesToFind+"");
